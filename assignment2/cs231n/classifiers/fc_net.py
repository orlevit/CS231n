...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        aff1, cache1 = affine_forward(X, W1, b1)
        rel1, cache2 = relu_forward(aff1)
        scores, cache3 = affine_forward(rel1, W2, b2)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
